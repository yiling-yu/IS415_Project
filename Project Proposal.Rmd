...
author:
  - name: Teo Jun Peng and Yu Yiling
    affiliation: Singapore Management Univeristy
date: "`r Sys.Date()`"
output: 
...
# 1. Theme: **Spatial Point Analysis**

# 2. Summary
To help bridge the gap between geospatial analysis and ease of use, Spatial Pointers is created to aid non-technical users with a specific type of geospatial analysis: Spatial Point Analysis. 

Our application will assist users with two methods of Spatial Point Analysis: Spatial Point Patterns Analysis and Network-Constrained Point Patterns Analysis. Spatial Point Patterns Analysis is helpful in finding out whether the input dataset point distribution resembles spatial randomness or regular/clustered pattern; or whether two input dataset point distributions are dependent on each other. Network-Constrained Point Patterns Analysis is helpful in finding out whether the distribution of spatial point events occurring on or alongside networks resembles spatial randomness or regular/clustered pattern. 
...
* Better understand the capabilities and use cases of Spatial Point Analysis
...
* Schools in Singapore ([primary school, secondary school, junior college](https://data.gov.sg/dataset/school-directory-and-information), [autonomous university](https://www.moe.gov.sg/microsites/whats-next/for-gce-a-level-students/where-do-i-want-to-go/i-want-to-further-my-studies/publicly-funded-autonomous-universities/index.html))
* [KFCs in Singapore](https://www.kfc.com.sg/Location/Search)

**Network-Constrained Point Patterns Analysis**

* [National Public Toilet Map (Australia)](https://data.gov.au/data/dataset/national-public-toilet-map)
* [Statewide Road Network (Australia)](https://data.sa.gov.au/data/dataset/roads)
* [Rest Areas - State Maintained (Australia)](https://data.sa.gov.au/data/dataset/rest-areas-state-maintained)
* [Petrol Stations (Australia)](https://data.gov.au/dataset/ds-ga-cc365600-2959-597d-e044-00144fdd4fa6/details?q=petrol%20stations)
* [Parks (Australia)](https://data.sa.gov.au/data/dataset/?tags=parks)
